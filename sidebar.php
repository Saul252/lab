                ...
                <div class="offcanvas-body">
                    ...
                    <div class="d-flex flex-column p-3 text-white bg-dark" style="height: 90vh; width: 100%;">
                        ...
                        <ul class="nav nav-pills flex-column mb-auto">
                            ...
                            <li class="nav-item">
                                <a href="/lab/estudios/estudios.php" class="nav-link ctive text-white hoverbutton">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none"
                                        stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                        class="me-2">
...
<script>
function confirmEliminarOrden(id){
  Swal.fire({
    title: 'Eliminar orden?',
    text: 'Se eliminarán los estudios relacionados',
    icon: 'warning',
    showCancelButton: true,
    confirmButtonText: 'Sí, eliminar',
  }).then((res)=>{
    if(res.isConfirmed){
      window.location = 'orden_eliminar.php?id_orden='+id;
    }
  });
}
</script>
